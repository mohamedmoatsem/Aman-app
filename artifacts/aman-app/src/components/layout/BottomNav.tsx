...
export default function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 inset-x-0 flex justify-center z-50 pointer-events-none">
      <div className="w-full max-w-2xl pointer-events-auto">
        <div className="absolute inset-0 bg-background/85 backdrop-blur-xl border-t border-border/50 rounded-t-2xl shadow-[0_-4px_24px_rgba(0,0,0,0.06)]" />
        <nav className="relative flex justify-around items-center px-2 py-2 pb-safe">
          {navItems.map((item) => {
            const isActive = location === item.href || (item.href === "/chat" && location === "/assistant");
            ...
            return (
              ...
              >
                <div className={clsx(
                  ...
                  <span className={clsx(
                    "text-[9px] font-medium transition-opacity duration-200 tracking-tight text-center",
